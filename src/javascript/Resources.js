...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'introNBase', source: './models/intro/a/base.glb' },
            { name: 'introNCollision', source: './models/intro/a/collision.glb' },
            ...
            { name: 'projectsBonhomme10ansFloor', source: './models/projects/bonhomme10ans/floorTexture.png', type: 'texture' },
