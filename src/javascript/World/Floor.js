...
export default class Floor
{
    constructor(_options)
    {
        ...
        this.geometry = new THREE.PlaneGeometry(2, 2, 10, 10)
          ...
          // Colors
          this.colors = {}
         this.colors.topLeft = '#9B1B30'
          this.colors.topRight = '#4a167c'
          this.colors.bottomRight = '#ffffff'
          this.colors.bottomLeft = '#e8326b'

          
        // this.colors.topLeft = '#1ea5a5'   // Deep Burgundy (Rich and Warm)1ea5a5
        // this.colors.topRight = '#FF7F32'  // Warm Amber (Golden Touch)
        // this.colors.bottomRight = '#7B6C3A' // Earthy Green (Natural)
        // this.colors.bottomLeft = '#F1C232'  // Golden Yellow (Vibrant and Bright)
