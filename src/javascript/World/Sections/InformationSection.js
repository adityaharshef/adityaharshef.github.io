...
export default class InformationSection
{
    ...
    setActivities()
    {
        // Set up
        this.activities = {}
        this.activities.x = this.x + 4
        this.activities.y = this.y - 12
        this.activities.multiplier = 10

        // Geometry
        this.activities.geometry = new THREE.PlaneGeometry(2 * this.activities.multiplier, 1 * this.activities.multiplier, 2, 2)
